    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Positioned(
            // Calculated bottom position based on button's absoluteBoundingBox.y (702) + height (56) = 758.
            // Screen height 812. So, 812 - 758 = 54px from bottom.
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: GoogleFonts.sora(
                      fontSize: screenWidth * (32 / figmaWidth), // Scale font size
                  ...
                  Text(
                    ...
                    textAlign: TextAlign.center,
                    style: GoogleFonts.sora(
                      fontSize: screenWidth * (14 / figmaWidth), // Scale font size
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text(
                        'Get Started',
                        style: GoogleFonts.sora(
                          fontSize: screenWidth * (16 / figmaWidth), // Scale font size
                          fontWeight: FontWeight.w600, // Sora-SemiBold
                          color: Colors.white,
                        ),
                      ),
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      ...
                      style: GoogleFonts.sora(
                        fontSize: screenWidth * (15 / figmaWidth), // Adjusted to fit common status bar time size, was 12px in bounds but generally larger
                        fontWeight: FontWeight.w600, // Inferring from visual
                        color: Colors.white,
                      ),
                    ),
                    Row(
